                    ...
                    <div className="liquid-glass rounded-lg p-12 mobile-contact-container">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                            <button
                                ...
                                className="inline-flex items-center gap-3 mobile-contact-button bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-medium transition-all duration-300"
                            >
                                <Mail size={20} />
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-3 mobile-contact-button bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg font-medium transition-all duration-300"
                            >
