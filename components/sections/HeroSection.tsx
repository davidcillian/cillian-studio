                    ...
                    <div className="w-full h-full relative">
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-blue-900/20 via-purple-900/20 to-cyan-900/20 flex items-center justify-center">
                            <div className="text-center">
                                <h1 className="text-2xl font-light text-[#f2f2f2] mb-4">Cillian Studio – 3D-Visualisierung, KI-Agenten & Gamification</h1>
                                <p className="text-[#aaa] text-lg">Creative Technology Consulting aus Wien</p>
